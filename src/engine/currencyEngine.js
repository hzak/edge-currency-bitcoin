...
export class CurrencyEngine {
  ...
  onBalanceChanged() {
    if (this.engineExtension && this.engineExtension.onBalanceChanged) {
      this.engineExtension.onBalanceChanged()
      return
    }
  ...
  async broadcastTx(
    ...
    if (this.engineExtension && this.engineExtension.onBroadcastTx) {
      await this.engineExtension.onBroadcastTx(edgeTransaction)
    }
